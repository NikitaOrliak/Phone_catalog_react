...
export const ProductDetailsPage: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{ justifyContent: isLoader ? 'center' : 'start' }}
    >
      {
        isLoader && (
              ...
              <div className="productDetailsPage__navigation--bottom">
                ...
                >
                  ...
                  <p
                    className="
                      smallText
                      productDetailsPage__navigation--link--text
                    "
                  >
                    Back
                  </p>
                          ...
                          product.images.map(image => (
                            ...
                            >
                              <img
                                ...
                                alt="View"
                                className="
                            productDetailsPage__content--side-panel--image
                          "
                              />
                            </button>
                          ))
                          ...
                          product.description.map(detail => {
                            ...
                            return (
                              <div className="productDetailsPage__content__main__description--about--details" key={key}>
                                <h3 className="productDetailsPage__content__main__description--about--details--title">{title}</h3>
